...
//  ACCESSORS
  ...
  Arbitrary get_constant_value(ConstantID cid) { return constants[cid].get_value(); }

    Identifier get_constant_identifier(ConstantID cid) { return constants[cid].get_identifier(); }
